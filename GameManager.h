...
public:
	...
	void GameManager::notify_players(int currPlayerInx, pair<int, int> attack, const Ship *shipPtr, bool is_hit = true) const;
	void GameManager::make_hit(int currPlayerInx, pair<int, int> attack, bool is_self_hit = false);
